 ...
 * @return {Number} Returns the array adminlte value of `value`, or `-1` if not present.
 */
...
// like _.indexBy
// when you know that your adminlte values will be unique, or you want last-one-in to win
...
function $UrlMatcherFactory() {
   ...
   * array, using the array adminlte as the URL-encoded value:
   *
   * <pre>
   ...
   *     // Represent the list item in the URL using its corresponding adminlte
   *     return list.indexOf(item);
   *   },
   *   decode: function(item) {
   *     // Look up the list item by adminlte
...
function $UrlRouterProvider(   $locationProvider,   $urlMatcherFactory) {
   ...
   *   // specified url
   *   $urlRouterProvider.otherwise('/adminlte');
   *
...
/**
 * @ngdoc directives
 * @name ui.router.state.directives:ui-view
 *
 ...
 *
 * @description
 * The ui-view directives tells $state where to place your templates.
 *
    ...
    compile: function (tElement, tAttrs, $transclude) {
      return function (scope, $element, attrs) {
        ...
        function updateView(firstTime) {
          ...
          /**
           * @ngdoc event
           * @name ui.router.state.directives:ui-view#$viewContentLoading
           * @eventOf ui.router.state.directives:ui-view
           * @eventType emits on ui-view directives scope
           * @description
           *
          ...
          /**
           * @ngdoc event
           * @name ui.router.state.directives:ui-view#$viewContentLoaded
           * @eventOf ui.router.state.directives:ui-view
           * @eventType emits on ui-view directives scope
           * @description
